...
export default function Footer() {
  ...
  return (
    <footer className="bg-[#353595] text-white py-12 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="grid md:grid-cols-4 gap-8 mb-8 text-center md:text-left">
          ...
          <div>
            <div className="flex items-center space-x-2 mb-4 justify-center md:justify-start">
              ...
              <span className="font-bold text-xl">VGC Events</span>
            </div>
            <p className="text-gray-200 text-sm">
              VGC Events is an event ticketing platform for memorable experiences in Victoria Garden City.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link href="/help" className="text-gray-200 hover:text-white transition-colors">
                  Help Center
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <p className="text-gray-200 text-sm mb-4">
              Sign up to receive information about upcoming VGC events.
            </p>
            <div className="flex flex-col sm:flex-row gap-2">
              <input
                type="email"
                placeholder="Your email"
                className="flex-1 px-4 py-2 rounded-lg bg-white text-gray-900 placeholder:text-gray-500 border border-white focus:outline-none focus:ring-2 focus:ring-white"
              />
              <button className="bg-white text-[#353595] px-6 py-2 rounded-lg hover:bg-gray-100 transition-colors font-semibold whitespace-nowrap">
                Subscribe
              </button>
            </div>
          </div>
        ...
        <div className="border-t border-white pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-200 text-sm mb-4 md:mb-0">
            © 2025 VGC Events. All rights reserved.
          </p>
